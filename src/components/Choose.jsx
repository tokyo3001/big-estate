...
function Choose() {
  return (
    <div className='mt-[126px]'>
        <p className='ml-[770px] font-display1 w-[511px] h-[45px] text-3xl'>
            Why Choose Big Estate?
        </p>
        <div className='flex mt-[38px] ml-[197px]'>
            <div>
            ...
            <div className='mt-[100px]'>
                ...
                <div className='rounded-xl shadow-slate-700 shadow-2xl mt-[-40px] ml-[36px] w-[230px] h-[170px] pt-16 pl-5'>

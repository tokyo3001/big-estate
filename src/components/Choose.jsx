    ...
    <div className='mt-[126px]'>
        ...
        <div className='lg:flex mt-[38px]'>
            <div className=''>
                ...
                <div className='rounded-xl shadow-slate-700 shadow-2xl mt-[-40px] lg:ml-[20px] ml-[110px] w-[200px] h-[170px] pt-16 pl-2'>
                    <p className='text-lg font-display1'>High Quality Leads</p>
                    <p className='text-sm w-[196px] h-[54px]'>All Based Targeting For 30% More Qualifies Leads</p>
                </div>
            </div>
            <div className='lg:mt-[100px] mt-[40px]'>
                <div className='bg-[#3461FF] lg:ml-[40px] ml-[150px] rounded-full w-[150px] h-[150px]'>
                    <img src={cpl} alt="" className='p-4 pt-6 pl-7'/>
                </div>
                <div className='rounded-xl shadow-slate-700 shadow-2xl mt-[-40px] ml-[110px] lg:ml-[10px] w-[200px] h-[170px] pt-16 pl-2'>

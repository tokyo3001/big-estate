...
function Header({ color }) {
  ...
  return (
    <div className='flex lg:h-28 h-28'>
        ...
        <div className='lg:visible invisible flex ml-[120px] mt-[47px] mr-[235px]'>
            <button className='border-2 border-solid border-[#3461FF] text-[#3461FF] rounded-full w-24'>Sign up</button>
            <button className='border-2 border-solid bg-[#3461FF] border-[#3461FF] text-white w-24 ml-2 rounded-full '>Log in</button>
        </div>
    </div>
  )
}
